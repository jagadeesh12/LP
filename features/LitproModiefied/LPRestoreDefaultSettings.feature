@regressionlp @restoresettings @regressionlpset4
Feature: LitPro Restore Default Settings
  ...
  @admin 
  Scenario: Set Default Settings for SA at school level
  ...
  @admin 
  Scenario: Return to Default Settings for SA at school level
    Given I browse to Settings Page as "admin"
    When I click the Restore Defaults button
    Then Settings Restored Message should be displayed
  ...
  @admin 
  Scenario: Return to Default Settings for SA at class level
    Given I browse to Settings Page as "admin"
    When I click the Restore Defaults button
    Then Settings Restored Message should be displayed
  ...
  @admin 
  Scenario: Return to Default Settings for SA at student level
    Given I browse to Settings Page as "admin"
    When I click the Restore Defaults button
    Then Settings Restored Message should be displayed
  ...
  @teacher
  Scenario: No Restore Defaultsbutton for Teacher at class level
    Given I browse to Settings Page as "Teacher"
    Then I should see that there is no Restore Defaults button

  @teacher @defect 
  Scenario: Return to Default Settings for Teacher at student level
    Given I browse to Settings Page as "Teacher"
    When I enter Settings search string "Martina"
    Then I should see Settings Page Page Header starting with "Joe Martina"
    When I click the Restore Defaults button
