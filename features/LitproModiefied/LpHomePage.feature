@functional @homepage @regressionlpfix @wip1 @regressionlpset1
Feature: LitPro users home page
  As a LitPro user 
  I should be able to view the following on my home page..

  @student @readinginterests  @defectOpen5259
  Scenario Outline: Create / Edit Reading Interests
    Given I launch LitPro homepage using "<username>" and "<password>" with "<usertype>"
