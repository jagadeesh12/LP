@regressionlp @defaultsettings @testset @regressionlpset1 @Fixtrq
Feature: LitPro Default Settings
  ...
  @admin  @SmokeLP
  Scenario: Default Settings for SA at school level
  ...
  @admin 
  Scenario: SA Default LitPro Settings at Class level
    Given I browse to Settings Page as "Admin"
    When I click the Restore Defaults button
    Then Settings Restored Message should be displayed
  ...
  @admin 
  Scenario: SA Default LitPro Settings at Student Level
    Given I browse to Settings Page as "Admin"
    When I click the Restore Defaults button
    Then Settings Restored Message should be displayed
  ...
  @teacher 
  Scenario: Teacher Default LitPro Settings at Class Level
  ...
  @teacher 
  Scenario: Teacher Default LitPro Settings at Student level
    Given I browse to Settings Page as "Teacher"
    When I enter Settings search string "Martina"
    Then I should see Settings Page Page Header starting with "Joe Martina"
    Then I should see following settings under LitPro Test Settings:
