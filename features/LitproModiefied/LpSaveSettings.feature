@regressionlp @savesettings @regressionlpfix @regressionlpset4
Feature: LitPro Save Settings by SA
  ...
  #for story 130
  # @admin 
  Scenario: Verify SA is able to change settings
  ...
  #@admin
  Scenario: Verify SA sees Save Settings Confirmation message
    Given I browse to Settings Page as "admin"
    When I click the Restore Defaults button
    Then Settings Restored Message should be displayed
    When I change all of the default settings
  ...
  #@admin 
  Scenario: Verify Setting Changes at School level are reflected at Class Level when using default settings
    Given I browse to Settings Page as "admin"
    When I click the Restore Defaults button
    Then Settings Restored Message should be displayed
    When I change all of the default settings
  ...
  #@admin
  Scenario: Verify Setting Changes at School level are reflected at Student Level when using default settings
    Given I browse to Settings Page as "admin"
    When I click the Restore Defaults button
    Then Settings Restored Message should be displayed
    When I change all of the default settings
  ...
  #@admin 
  Scenario: Verify Setting Changes at School level are not reflected at Class Level when Class settings have been changed
    Given I browse to Settings Page as "admin"
    When I click the Restore Defaults button
    Then Settings Restored Message should be displayed
    When I enter Settings search string "Math"
    ...
    Then I should see Settings Page Page Header starting with "breaking bad"
    When I change all of the default settings
    When I click the Settings page Save button
    Then 'Settings Saved' Message should be displayed
    Then I should see following settings under LitPro Test Settings:
  ...
  #130
  @admin @defect 
  Scenario: Verify Setting Changes at School level are not reflected at Student Level when Student settings have been changed
    Given I browse to Settings Page as "admin"
    When I click the Restore Defaults button
    Then Settings Restored Message should be displayed
    When I enter Settings search string "Martina"
  ...
  Scenario: Verify Save Setting Confirmation message at Class level
    Given I browse to Settings Page as "admin"
    When I click the Restore Defaults button
    Then Settings Restored Message should be displayed
    When I enter Settings search string "Math"
  ...
  Scenario: Verify Changes at Class level Saved at Class level
    Given I browse to Settings Page as "admin"
    When I click the Restore Defaults button
    Then Settings Restored Message should be displayed
    When I enter Settings search string "Math"
  ...
  Scenario: Verify Changes at Class level saved at Student level
    Given I browse to Settings Page as "admin"
    When I click the Restore Defaults button
    Then Settings Restored Message should be displayed
    When I enter Settings search string "Math"
  ...
  Scenario: Verify Setting Changes at Class level are not reflected at School Level
    Given I browse to Settings Page as "admin"
    When I click the Restore Defaults button
    Then Settings Restored Message should be displayed
    When I enter Settings search string "Math"
  ...
  Scenario: Verify Setting Changes at Class level are not reflected on other Classes
    Given I browse to Settings Page as "admin"
    When I click the Restore Defaults button
    Then Settings Restored Message should be displayed
    When I enter Settings search string "Math"
  ...
  #132
  @admin 
  Scenario: Verify Setting Changes at Student level confirmation message
    Given I browse to Settings Page as "admin"
    When I click the Restore Defaults button
    Then Settings Restored Message should be displayed
    When I enter Settings search string "Martina"
  ...
  #132
  @admin   
  Scenario: Verify Setting Changes at Student saved at student level
    Given I browse to Settings Page as "admin"
    When I click the Restore Defaults button
    Then Settings Restored Message should be displayed
     When I click the Settings page Save button
  ...
  #132
  @admin  
  Scenario: Verify Setting Changes at Student level are not reflected at School Level
    Given I browse to Settings Page as "admin"
    When I click the Restore Defaults button
    Then Settings Restored Message should be displayed
    When I enter Settings search string "Martina"
  ...
  #132
  @admin 
  Scenario: Verify Setting Changes at Student level are not reflected at Class Level
    Given I browse to Settings Page as "admin"
    When I click the Restore Defaults button
    Then Settings Restored Message should be displayed
    When I enter Settings search string "Martina"
  ...
  #132 Ed McCreery
  @admin 
  Scenario: Verify Setting Changes at Student do not affect other students
    Given I browse to Settings Page as "admin"
    When I click the Restore Defaults button
    Then Settings Restored Message should be displayed
     And I click Save
