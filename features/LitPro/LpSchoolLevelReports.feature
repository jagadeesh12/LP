@functional @reports @regressionlp @LPSchoolLevelReports.feature
Feature: LitPro Reports UI validation at School level
  ...
  @admin @regression 
    Scenario Outline: Reading Proficiency Report UI verification
    Given I launch Litpro and browse to 'Reports' page using "<username>" and "<password>" with with "<usertype>"
  ...
  @admin @regression 
  Scenario Outline: Book Comprehension Report UI verification
    Given I launch Litpro and browse to 'Reports' page using "<username>" and "<password>" with with "<usertype>"
    Then I should see Reports page header with text "Reports for"
  ...
  @admin @regression 
  Scenario Outline: Quiz Pass Rate Report UI verification
	Given I launch Litpro and browse to 'Reports' page using "<username>" and "<password>" with with "<usertype>"
    Then I should see Reports page header with text "Reports for"
